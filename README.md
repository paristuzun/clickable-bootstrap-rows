...
```
 <div class="container mt-lg-6 mt-5">
        <div class="row">
            ...
            <div class="bg-hover-white-smoke w-100 pointer" onclick="location.href='images/image-1.jpg'" target="_blank">
                <div class="container">
            ...
            <div class="bg-hover-white-smoke w-100 pointer" onclick="location.href='images/image-2.jpg'">
                <div class="container">
                    <div class="row py-4 align-items-center border-top clickable-row">
                        <div class="col-md-10">
                            <h3 class="h4 m-0">
        ...
        <div class="bg-hover-white-smoke w-100 pointer" onclick="location.href='images/image-3.jpg'">
            <div class="container">
                <div class="row py-4 align-items-center border-top clickable-row">
                    <div class="col-md-10">
                        <h3 class="h4 m-0">
            ...
            <div class="bg-hover-white-smoke w-100 pointer" onclick="location.href='images/image-4.jpg'">
                <div class="container">
                    <div class="row py-4 align-items-center border-top clickable-row">
                        <div class="col-md-10">
                            <h3 class="h4 m-0">
